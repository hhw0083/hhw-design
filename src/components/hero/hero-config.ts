...
export const HERO_CONFIG = {
  ...
  model: {
    startPosition: [1.04, 0.02, 0] as Vector3Tuple,
  ...
  lights: {
    ...
    keyPositionStart: [-4.4, 2.15, 4.2] as Vector3Tuple,
    keyPositionEnd: [-2.1, 3.4, 4.2] as Vector3Tuple,
    keyIntensityStart: 3.8,
    keyIntensityEnd: 3.8,
    fillPosition: [3.6, -0.7, 3.4] as Vector3Tuple,
    fillIntensity: 0.48,
    rimPosition: [4.9, 0.7, -3.7] as Vector3Tuple,
    rimIntensity: 2.35,
  },
  fog: {
    startDensity: 0.078,
